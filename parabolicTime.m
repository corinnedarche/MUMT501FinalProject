function [peakVals, ind, timeInd] = parabolicTime(input, a, t)
% Function: parabolic2D.m
% Created by: Corinne Darche
% Use parabolic interpolation to find the peaks with the time-domain
% function as input

% The time-domain detection function goes from negative to positive, so we
% need to pick peaks differently
